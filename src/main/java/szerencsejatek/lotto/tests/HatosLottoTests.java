...
public class HatosLottoTests extends DriverFactory {
    ...
    public void normalHatosLottoTest() {
        ...
        if (homePageLoggedin.isDropDownMenuButton()) {
            log.info("We check if the dropdown menu is available");
        } else {
            log.error("The TES-T37 FAILED - The dropdown menu is unavailable");
        }
        ...
        if (hatosLottoPage.isHatoslottoPageLoaded()) {
            log.info("We check if the Hatoslotto page is loaded");
        } else {
            log.error("The TES-T37 FAILED - The Hatoslotto page is unavailable");
        }
        ...
        if (hatosLottoPage.areZeroNumbersSelected()) {
            log.info("We check whether the number of selected numbers is zero");
        } else {
            log.error("The TES-T37 FAILED - The amount of selected numbers is not 0");
        }
        ...
        if (hatosLottoPage.areSixNumbersSelected()) {
            log.info("We check that 6 numbers are selected");
        } else {
            log.error("The TES-T37 FAILED - No 6 numbers are selected");
        }
        ...
        if (cartPage.isCartPageLoaded()) {
            ...
            log.error("The TES-T37 FAILED - The Cart page is unavailable");
        }
